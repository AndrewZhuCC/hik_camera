...
FROM harbor.lotuscars.com.cn/edge-box/tiny_cv2:arm64
...
RUN wget https://www.hikrobotics.com/cn2/source/support/software/MVS_STD_GML_V2.1.2_221208.zip  \
    ...
    && dpkg -i MVS-2.1.2_aarch64_20221208.deb \
    && rm MVS*.deb MVS*.gz MVS*.zip

ENV MVCAM_COMMON_RUNENV=/opt/MVS/lib LD_LIBRARY_PATH=/opt/MVS/lib/aarch64:$LD_LIBRARY_PATH PYTHONPATH=/hik_camera:$PYTHONPATH
